...
const productSchema = new mongoose.Schema({
    ...
    reviews: [
        {                            // ejecting 'User' - the one who adds the product
          user: {
            type: mongoose.Schema.ObjectId,
            ref: "User",                         // the name of the table we are refering while creating that particular model
            required: true,
          },
          name: {
            type: String,
    ...
    user: {                              // will help us know who added the product (eg - admin, manager ....)
        type: mongoose.Schema.ObjectId,
        ref: "User",
        required: true,
    },
